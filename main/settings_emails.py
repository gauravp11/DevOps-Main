...
EMAIL_USE_TLS = False
EMAIL_PORT = 1025
EMAIL_HOST_USER = env('EMAIL_HOST_USER', 'blackcrpf@protonmail.com')
EMAIL_HOST_PASSWORD = env('EMAIL_HOST_PASSWORD', 'Testuser23')
...
TASKS_VIEWER_ENABLED = env.bool('TASKS_VIEWER_ENABLED', True)
