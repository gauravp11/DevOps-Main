...
REST_ENABLED = env.bool('REST_ENABLED', True)
if REST_ENABLED:
...
#LANGUAGE_CODE = env('LANGUAGE_CODE', 'hi')
...
en_formats.DATETIME_FORMAT = 'd M Y, h:i:s A'
...
APP_NAME = env('APP_NAME', ' TaskSync')
APP_EMAIL = env('APP_EMAIL', 'no-reply@localhost')
SITE_HEADER = env('SITE_HEADER', 'TaskSync')
